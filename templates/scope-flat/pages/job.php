...
<div id="social-bar">
	<div>
		<a href="http://www.facebook.com/sharer.php?u=<?=urlencode($pageUrl)?>" target="_blank" class="primary-bg">
			<i class="fab fa-facebook-f"></i>
		</a>
	</div>
	<div>
		<a href="https://twitter.com/share?url=<?=urlencode($pageUrl)?>" target="_blank" class="primary-bg">
			<i class="fab fa-twitter"></i>
		</a>
	</div>
	<div>
		<a href="https://www.xing.com/spi/shares/new?url=<?=urlencode($pageUrl)?>" target="_blank" class="primary-bg">
			<i class="fab fa-xing"></i>
		</a>
	</div>
	<div>
		<a href="https://www.scope-recruiting.de/jobs/printJob/<?=$jobId?>/<?=$locationId?>" target="_blank" class="primary-bg">
...
<div id="mobile-social-bar">
	...
	<div>
		<a href="http://www.facebook.com/share.php?u=<?=urlencode($pageUrl)?>" target="_blank" class="primary-bg scope_facebook_share"><i
					class="fab fa-facebook-f" aria-hidden="true"></i></a>
	</div>
	<div>
		<a href="https://twitter.com/share?url=<?=urlencode($pageUrl)?>"
	...
	<div>
		<a href="https://www.xing.com/spi/shares/new?url=<?=urlencode($pageUrl)?>"
